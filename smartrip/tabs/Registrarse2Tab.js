...
import Registrarse2Tab from './Registrarse3Tab';

export default function Registrarse2() {
      ...
      <ScrollView>
        <View style={styles.container}>
          ...
          <View style={styles.form}>
            <Text style={styles.h1}>Información de Cuenta</Text>
            <Text style={styles.h2}>Crea tu cuenta para SmarTrip</Text>

            {/* EMAIL */}
            <Text style={styles.label}>Email</Text>
            <View style={styles.inputContainer}>
              <Icon name="email" size={20} color="#BDD7DD" style={styles.icon} />
              <TextInput
                style={styles.input}
